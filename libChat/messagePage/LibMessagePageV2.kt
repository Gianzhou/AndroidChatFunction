...
class LibMessagePageV2: LibBaseBackPage(), LibMessageItemClickListener {
...
private lateinit var mtest : ImageView
    ...
    companion object {
        ...
        fun newInstance(title: Int, chatConversation : LibChatModel): LibMessagePageV2 {
            val bundle = Bundle()
            bundle.putInt(titleKey, title)

            val fragment = LibMessagePageV2()
    ...
    private fun initViewFromXml(inflater: LayoutInflater, container: ViewGroup?): View {
        val view = inflater.inflate(R.layout.lib_chat_detail_v2, container, false)
